...
open class ItemBaseController<T: UIView>: UIViewController, ItemController, UIGestureRecognizerDelegate, UIScrollViewDelegate where T: ItemView {
    ...
    func findVisibleDisplacedView() -> DisplaceableView? {
        ...
        guard let displacedView = displacedViewsDataSource?.provideDisplacementItem(atIndex: index) else {
            return nil
        }
    ...
    public func gestureRecognizerShouldBegin(_ gestureRecognizer: UIGestureRecognizer) -> Bool {
        ...
        guard gestureRecognizer == swipeToDismissRecognizer else {
            return false
        }
        ...
        ///A bit of paranoia
        guard velocity.orientation != .none else {
            return false
        }
